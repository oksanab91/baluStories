...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="post-thumbnail">
        <?php ( is_active_sidebar( 'right-sidebar' ) && ( $sidebar_layout == 'right-sidebar' ) ) ? the_post_thumbnail( 'travel-diaries-image-with-sidebar' ) : the_post_thumbnail( 'travel-diaries-image-full-width' ) ; ?>
    </div>
    <?php } ?>
